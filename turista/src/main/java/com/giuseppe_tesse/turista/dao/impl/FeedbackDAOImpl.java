...
public class FeedbackDAOImpl implements FeedbackDAO {
    ...
    private final String ALL_JOIN = "SELECT \r\n" +
            "    f.id AS id, \r\n" +
            "    f.title AS title, \r\n" +
    ...
    public Feedback create(Feedback feedback) {
        log.info("Creating new feedback for booking ID: {} by user ID: {}", feedback.getBooking().getId(),
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            log.error("Error creating feedback for booking ID: {} by user ID: {}", feedback.getBooking().getId(),
                    feedback.getUser().getId(), e);
    ...
    public Integer getFeedbackCount() {
        log.info("Returning count of all feedbacks");
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                log.info("Successfully retrieved {} feedbacks count", count);
                return count;
            }
            ...
            log.error("Error retrieving feedbacks count", e);
            throw new RuntimeException("Error retrieving feedbacks count", e);
        }
    }
